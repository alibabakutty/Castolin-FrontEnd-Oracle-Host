    ...
    >
      ...
      <td className="border border-gray-400 text-sm w-20 align-middle p-0">
        <input
          ...
          className="w-full h-full pl-1 font-medium text-[12px] focus:bg-yellow-200 focus:outline-none focus:border-blue-500 focus:border border-transparent text-right"
          readOnly
        />
      </td>
