      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-medium text-gray-700">Distributor Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">Customer Management</h3>
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">Inventory</h3>
            <p className="text-gray-600">Check stock levels and products</p>
          </div>
        </button>
        ...
        >
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">Performance</h3>
