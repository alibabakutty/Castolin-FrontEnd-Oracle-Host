...
const Order = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    const editingRowRate = Number(editingRow.rate || 0);

    const totalAmountValue = (totalAmt + editingRowAmount) + (totalSgstAmt + editingRowSgst) + (totalCgstAmt + editingRowCgst) + (totalIgstAmt + editingRowIgst);
    ...
    setTotals({
      ...
      netAmt: totalNetRate + editingRowRate,
      grossAmt: totalGrossAmt + editingRowAmount,
